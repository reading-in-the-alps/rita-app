...
module namespace api="http://www.digital-archiv.at/ns/rita-app/api";
declare namespace rest = "http://exquery.org/ns/restxq";
declare namespace tei = "http://www.tei-c.org/ns/1.0";
import module namespace functx = "http://www.functx.com";
import module namespace app="http://www.digital-archiv.at/ns/rita-app/templates" at "app.xql";
import module namespace config="http://www.digital-archiv.at/ns/rita-app/config" at "config.xqm";
...
declare 
    %rest:GET
    %rest:path("/rita-app/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/rita-app/dt/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/rita-app/{$collection}/{$id}/{$format}")
